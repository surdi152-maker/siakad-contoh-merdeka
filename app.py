...
def set_custom_css():
    st.markdown("""
        ...
        div[data-baseweb="input"] { background-color: #15181F !important; border-color: #2A2E39 !important; }
        label { color: #A0AEC0 !important; font-weight: 500; }
        </style>
